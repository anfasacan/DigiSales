...
REM -------------- Call Function
Call spLoadLibrary()
Call spInitiateData("DigisalesLib_Report.xlsx", "SCD0012-003 - Admin SLN melakukan meng-aktifkan atau me-nonaktifkan parameter KPI.xlsx", "SCD0012")
Call spGetDatatable()
...
Call Parameter_KPI_Active_to_Inactive()
Call Check_Parameter_KPI()
Call DA_Logout("0")
Call spReportSave()
