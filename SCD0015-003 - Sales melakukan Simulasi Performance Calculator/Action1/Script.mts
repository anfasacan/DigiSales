...
REM -------------- Call Function
Call spLoadLibrary()
Call spInitiateData("DigisalesLib_Report.xlsx", "SCD0015-003 - Sales melakukan Simulasi Performance Calculator.xlsx", "SCD0015")
Call spGetDatatable()
...
Call GeneratePerformanceCalculator()
Call ListDataPerformanceCalculator()
Call CalculatePerformanceCalculator()
