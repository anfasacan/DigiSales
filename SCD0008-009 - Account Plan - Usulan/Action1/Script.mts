...
Dim dtNavbarMenu, dt_UserLogin,dt_Periode

REM -------------- Call Function
Call spLoadLibrary()
Call spInitiateData("DigisalesLib_Report.xlsx", "SCD0008-009 - Account Plan-Usulan.xlsx", "SCD0008")
Call spGetDatatable()
Call fnRunningIterator()
Call spReportInitiate()
Call spAddScenario(dt_TCID, dt_TestScenarioDesc, dt_ScenarioDesc, dt_ExpectedResult, Array("Login Sebagai : " & dt_UserLogin, "Periode Data : " & dt_Periode))

REM ------- Digisales mobile
Call DA_LoginMobile()
Call FR_GoTo_NavbarMenu(dtNavbarMenu)
Call GoToSubNavbar()
Call FilterAccountPlan()
