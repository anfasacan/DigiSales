...
REM -------------- Call Function
Call spLoadLibrary()
Call spInitiateData("DigisalesLib_Report.xlsx", "SCD0024-005 - Fitur Pada Customer Service.xlsx", "SCD0024")
Call spGetDatatable()
...
Call OpenLastDownloadFile(DataTable.Value("FILE1",dtlocalsheet), "EXCEL")
Call spReportSave()
