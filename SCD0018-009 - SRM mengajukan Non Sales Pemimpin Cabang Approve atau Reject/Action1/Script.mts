...
REM -------------- Call Function
Call spLoadLibrary()
Call spInitiateData("DigisalesLib_Report.xlsx", "SCD0018-009 - SRM mengajukan Non Sales Pemimpin Cabang Approve atau Reject.xlsx", "SCD0018")
Call spGetDatatable()
...
ElseIf iteration = 5 Then
	...
	Call FR_GoTo_SidebarMenu(dtSidebarMenu)
	Call TolakApproval()
ElseIf iteration = 3 or iteration = 6 Then
	Call DA_Login()
