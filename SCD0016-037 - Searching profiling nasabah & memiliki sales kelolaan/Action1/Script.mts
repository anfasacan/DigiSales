...
REM -------------- Call Function
Call spLoadLibrary()
Call spInitiateData("DigisalesLib_Report.xlsx", "SCD0016-037 - Searching profiling nasabah & memiliki sales kelolaan.xlsx", "SCD0016")
Call spGetDatatable()
...
If iteration = 2 or iteration = 4 or iteration = 6 Then
	Call DA_Login()
...
If iteration = 3 or iteration = 5 or iteration = 7 Then
	Call DA_LoginMobile()
	Call GoToSubNavbar()
