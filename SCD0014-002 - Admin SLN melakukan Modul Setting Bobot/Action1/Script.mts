...
REM -------------- Call Function
Call spLoadLibrary()
Call spInitiateData("DigisalesLib_Report.xlsx", "SCD0014-002 - Admin SLN melakukan Modul Setting Bobot.xlsx", "SCD0014")
Call spGetDatatable()
...
Call Search_Setting_Bobot()
Call Edit_Setting_Bobot()
Call DA_Logout("0")
Call spReportSave()
