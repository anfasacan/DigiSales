...
Dim dt_UserLogin, dt_Bulan, dt_Tahun, dt_JenisNasabah, dt_File1
Dim DownloadPath

REM -------------- Call Function
Call spLoadLibrary()
Call spInitiateData("DigisalesLib_Report.xlsx", "SCD0011-039 - Sales mengakses menu Report Menu - Product Holding Ratio - Report.xlsx", "SCD0011")
Call spGetDatatable()
Call fnRunningIterator()
Call spReportInitiate()
Call spAddScenario(dt_TCID, dt_TestScenarioDesc, dt_ScenarioDesc, dt_ExpectedResult, Array("Login Sebagai : " & dt_UserLogin, "Data Periode : " & dt_Bulan &" "& dt_Tahun, "Jenis Nasabah : "& dt_JenisNasabah, "Nama File : " & dt_File1))
