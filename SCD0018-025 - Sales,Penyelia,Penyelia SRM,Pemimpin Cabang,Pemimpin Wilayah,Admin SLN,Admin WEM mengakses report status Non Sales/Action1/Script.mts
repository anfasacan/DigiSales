...
REM -------------- Call Function
Call spLoadLibrary()
Call spInitiateData("DigisalesLib_Report.xlsx", "SCD0302 - Sales,Penyelia,Penyelia SRM,Pemimpin Cabang,Pemimpin Wilayah,Admin SLN,Admin WEM mengakses report status Non Sales.xlsx", "SCD0302")
Call spGetDatatable()
