...
Dim dtNavbarMenu, dt_UserLogin,dt_PeriodeDanaMasuk

REM -------------- Call Function
Call spLoadLibrary()
Call spInitiateData("DigisalesLib_Report.xlsx", "SCD0010-112 - Penyesuaian Kriteria Account Plan Asisten Penjualan.xlsx", "SCD0010")
Call spGetDatatable()
...
Sub spGetDatatable()
	...
	dt_PeriodeDanaMasuk			= DataTable.Value("TEXT4",dtLocalSheet)
